...
class Solution:
    ...
    #     tmpIndex = 0
    #
    #     while tmpIndex < len(self.littleValMaxHeap):
    #         leftIndex = 2 * tmpIndex + 1
    #         rightIndex = 2 * tmpIndex + 2
    #         largerIndex = 0
    #
    ...
    #             break
    #
    #         if self.littleValMaxHeap[tmpIndex] < self.littleValMaxHeap[largerIndex]:
    #             self.littleValMaxHeap[tmpIndex], self.littleValMaxHeap[largerIndex] = \
    #                         self.littleValMaxHeap[largerIndex], self.littleValMaxHeap[tmpIndex]
    #
    #         # if self.littleValMaxHeap[tmpIndex] < self.littleValMaxHeap[lagerIndex]:
    #         #     self.littleValMaxHeap[tmpIndex], self.littleValMaxHeap[lagerIndex] = \
    #         #         self.littleValMaxHeap[lagerIndex],  self.littleValMaxHeap[tmpIndex]
    #
